qn <- c("The guy in front of me just bought a pound of bacon, a bouquet, and a case of",
        ...
        "I will follow you to the beach if you follow me to the forest",
...
tdm.sb <- TermDocumentMatrix(c.corp)

ass.sb1 <- findAssocs(tdm.sb, dimnames(tdm.sb)$Terms[1:40], rep(.5, 40))
#ass.sb <- findAssocs(tdm.sb, c("follow", "garage"), .5)
